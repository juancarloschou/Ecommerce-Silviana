...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'freestore' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'freestore' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'freestore' ),
		'cyrillic'     => __( 'Cyrillic', 'freestore' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'freestore' ),
		'devanagari'   => __( 'Devanagari', 'freestore' ),
		'greek'        => __( 'Greek', 'freestore' ),
		'greek-ext'    => __( 'Greek Extended', 'freestore' ),
		'khmer'        => __( 'Khmer', 'freestore' ),
		'latin'        => __( 'Latin', 'freestore' ),
		'latin-ext'    => __( 'Latin Extended', 'freestore' ),
		'vietnamese'   => __( 'Vietnamese', 'freestore' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'freestore' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'freestore' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'freestore' ),
