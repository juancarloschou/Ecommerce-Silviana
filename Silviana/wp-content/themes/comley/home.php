...
<section id="content" class="wow fadeInUp">
  <div class="container">
  <?php if(get_theme_mod('blog_posts_layouts') && get_theme_mod('blog_posts_layouts')=='listlayout'){ ?>
  <div class="row">
	...
	if(get_theme_mod('blog_layouts')=='blogwithrightsidebar') { ?>
