...
function googleStaticFieldOptions( fieldName ) {
    switch ( fieldName ) {
        ...
        case 'excluded_destination':
            var options = new Array( 'Shopping', 'ShoppingActions', 'DisplayAds' );
            break;
...
function wppfm_doublesFieldsAllowed() {
	return [ 'display_ads_similar_id', 'excluded_destination', 'adwords_labels', 'shipping' ];
}
